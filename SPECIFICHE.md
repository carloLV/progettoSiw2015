...
Il cliente pu√≤ svolgere le seguenti operazioni:
...
Ogni prodotto puo' essere fornito da un solo fornitore, ogni fornitore puo' fornire uno o pi√π prodotti
...
L'utente sceglie un prodotto e aggiunge codice e quantita'† del prodotto scelto all'ordine
...
L'utente ripete i due passi precedenti finche' necessario
L'utente "chiude" l'ordine
Il sistema registra l'ordine
Precondizioni: L'utente Ë identificato e autenticato
